...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1400px] mx-auto w-full flex flex-col gap-16 lg:gap-24 z-10">
        {/* Row 1: Heading and Logo */}
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8 w-full">
          ...
          <div className="flex-1 min-w-0 w-full">
            ...
            <h1 className="text-[clamp(3.8rem,10.5vw,10.5rem)] font-bold leading-[0.9] tracking-[-0.04em]">
              {words.map((word, i) => (
                <motion.span
                  key={i}
        ...
        {/* Row 2: Description and Download CTA */}
        <div className="w-full flex flex-col md:flex-row justify-between items-start md:items-end gap-8 pt-8 border-t border-white/[0.04]">
          <motion.p
          ...
          <motion.div
            ...
            className="flex flex-col gap-4 flex-shrink-0 md:items-end w-full md:w-auto"
          >
