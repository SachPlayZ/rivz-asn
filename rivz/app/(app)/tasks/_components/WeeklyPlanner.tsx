        ...
        {days.map((day) => {
          ...
          return (
            <div
              key={day.toISOString()}
              className={cn(
                "flex flex-col gap-1.5 rounded-xl border border-border p-2 min-h-[120px]",
              ...
              {dayTasks.length === 0 ? (
                ...
                dayTasks.map((task) => (
                  <button
                    ...
                    className="w-full text-left flex items-start gap-1 rounded-md bg-card border border-border/50 px-1.5 py-1 hover:border-border transition-colors"
                  >
                    <span
                      className={cn(
